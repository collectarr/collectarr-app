...
> Historical baseline snapshot. This document records the architecture at its
> stated checkpoint and is retained for migration context. Its file inventory
> and pending-work lists are not a current audit; check the live source tree.
