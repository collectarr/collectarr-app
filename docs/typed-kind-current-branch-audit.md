...
HEAD: `acd8791b` (`refactor(tracking): narrow generic mutation payload`)
...
Latest verification after typed seed coverage, AniList boundary cleanup, legacy mapper deletion, TV hierarchy migration, TV personal-import ownership, reset-script cleanup, universal Calendar contributors, generic Calendar watch projection, TV season import ownership, universal Activity contributors, generic Activity watch projection, and narrowed generic tracking mutation payloads: the checker reports 503 AST violations and 392 informational complexity warnings.
