...
HEAD: `b3bcbe41` (`refactor(settings): keep prefill defaults universal`)
...
| 69 | Admin kind-specific screens/actions | **PARTIAL** | Admin still contains generic semantic correction forms; a kind-owned contributor/action boundary is the next migration. |
