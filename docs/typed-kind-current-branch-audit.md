...
HEAD: `5136be7a` (`refactor(calendar): compose generic watch contributor`)
...
Latest verification after typed seed coverage, AniList boundary cleanup, legacy mapper deletion, TV hierarchy migration, TV personal-import ownership, reset-script cleanup, universal Calendar contributors, generic Calendar watch projection, TV season import ownership, and universal Activity contributors: the checker reports 503 AST violations and 392 informational complexity warnings.
