...
HEAD: `59b27cd9` (`refactor(activity): move generic watch projection to host`)
...
Latest verification after typed seed coverage, AniList boundary cleanup, legacy mapper deletion, TV hierarchy migration, TV personal-import ownership, reset-script cleanup, universal Calendar contributors, generic Calendar watch projection, TV season import ownership, universal Activity contributors, and generic Activity watch projection: the checker reports 503 AST violations and 392 informational complexity warnings.
