...
final class CatalogItemDto {
  ...
  factory CatalogItemDto({
    ...
    dynamic creators,
    dynamic characters,
    dynamic characterDetails,
    dynamic storyArcs,
    dynamic rawPlatforms,
    dynamic platforms,
    dynamic boardGameStats,
    dynamic genres,
    String? country,
    String? language,
    String? ageRating,
  ...
  }) = CatalogItemDto.fromFields;

  factory CatalogItemDto.fromFields({
    required String id,
    String? kind,
    CatalogMediaKind? mediaKind,
    required String title,
    ...
    final resolvedKind = mediaKind ?? catalogMediaKindFromApiValue(kind);
    final common = CatalogCommonDto(
      ...
      releaseDate: releaseDate ?? coverDate,
      releaseYear: releaseYear ?? releaseDate?.year ?? coverDate?.year,
      editions: editions ?? const <CatalogEditionDto>[],
      trailerUrls: trailerUrls ?? const <TrailerLinkDto>[],
    );
    final dynamicPayload = <String, dynamic>{
      ...
      if (trailerUrls != null)
        'trailer_urls': trailerUrls.map((e) => e.toJson()).toList(),
      ...
      if (video != null)
        'video': video is Map ? video : (video as dynamic).toJson(),
      if (music != null)
        'music': music is Map ? music : (music as dynamic).toJson(),
      if (game != null)
        'game': game is Map ? game : (game as dynamic).toJson(),
      if (publishing != null)
        'publishing':
            publishing is Map ? publishing : (publishing as dynamic).toJson(),
      if (creators != null) 'creators': creators,
      if (characters != null) 'characters': characters,
      if (characterDetails != null) 'character_details': characterDetails,
      if (storyArcs != null) 'story_arcs': storyArcs,
      if (rawPlatforms != null) 'platforms': rawPlatforms,
      if (platforms != null) 'platforms': platforms,
      if (boardGameStats != null)
        ...(boardGameStats is Map
            ? Map<String, dynamic>.from(boardGameStats)
            : Map<String, dynamic>.from(
                (boardGameStats as dynamic).toJson() as Map)),
    ...
    return CatalogItemDto.raw(
      ...
      common: common,
      payload: Map<String, dynamic>.unmodifiable(dynamicPayload),
    );
  }
