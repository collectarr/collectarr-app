    ...
    return Column(
      children: [
        ...
        _ComicsToolbar(
          ...
          onScanBarcode: onScanBarcode,
          onRefreshMetadata: () => _showMetadataRefreshPlaceholder(context),
          onShowStats: () => _showStatsDashboardDialog(
            context,
            state: shelfState,
            selectedSeries: selectedSeries,
            missingIssues: missingIssues,
...
Future<void> _showStatsDashboardDialog(
  BuildContext context, {
                            ...
                            _StatsHealthCard(
                              ...
                              rows: [
                                _StatsHealthRow(
                                  ...
                                  value:
                                      '${state.pricedCount}/${state.ownedCount}',
                                  fraction: valueCoverage,
                                ),
                                _StatsHealthRow(
                                  label: 'Graded coverage',
                                  value:
                                      '${state.ownedCount - state.missingGradeCount}/${state.ownedCount}',
                                ...
                                _StatsHealthRow(
                                  ...
                                  value:
                                      '${state.entries.length - missingMetadata}/${state.entries.length}',
...
Map<String, int> _countBy(
  ...
  final counts = <String, int>{};
  for (final entry in entries) {
    final key = keyFor(entry).trim().ifEmpty('Unknown');
...
class _InspectorSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          color: const Color(0xC9222222),
          borderRadius: BorderRadius.circular(2),
          border: Border.all(color: const Color(0x5A4DBBD5)),
          boxShadow: const [
            BoxShadow(
          ...
          child: Column(
            ...
            children: [
              DecoratedBox(
                decoration: const BoxDecoration(
                  border: Border(
                    bottom: BorderSide(color: Color(0x334DBBD5)),
                  ),
                ),
                child: Padding(
