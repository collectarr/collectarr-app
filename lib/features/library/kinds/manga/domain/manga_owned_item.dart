...
final class MangaOwnedItem {
  ...
  Map<String, dynamic> toJson() => {
        ...
        ...mangaOwnedTargetLegacyFields(targetRef),
        'condition': condition,
        'grade': grade,
...
CatalogEntityRef? mangaOwnedTargetRefFromLegacy(
  CatalogEntityRef catalogRef, {
  String? anchorType,
  String? editionId,
  String? variantId,
...
Map<String, dynamic> mangaOwnedTargetLegacyFields(
