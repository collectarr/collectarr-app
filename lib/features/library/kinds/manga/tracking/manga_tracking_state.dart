...
final class MangaTrackingState extends PersonalTrackingBase
  ...
  @override
  MangaTrackingState copyWithProgress(TrackingProgressSnapshot progress) {
    return copyWith(
