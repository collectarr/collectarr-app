...
final class MusicOwnedItem {
  ...
  Map<String, dynamic> toJson() => {
        ...
        ...musicOwnedTargetLegacyFields(targetRef),
        'condition': condition,
        'grade': grade,
  ...
  factory MusicOwnedItem.fromJson(Map<String, dynamic> json) {
    ...
    return MusicOwnedItem(
      ...
      targetRef: musicOwnedTargetRefFromLegacy(
        catalogRef,
...
CatalogEntityRef? musicOwnedTargetRefFromLegacy(
  CatalogEntityRef catalogRef, {
  String? anchorType,
  String? editionId,
  String? variantId,
...
Map<String, dynamic> musicOwnedTargetLegacyFields(CatalogEntityRef? targetRef) {
