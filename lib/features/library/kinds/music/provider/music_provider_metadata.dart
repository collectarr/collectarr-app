...
/// cross-kind candidate. The payload is a concrete Music catalog-item
/// candidate, and the Add host adapts it only after it reaches Music.
...
///
/// It deliberately does not implement the erased raw metadata capability.
