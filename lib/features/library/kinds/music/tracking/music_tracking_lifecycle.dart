...
final class MusicTrackingLifecycle extends PersonalTrackingBase
  ...
  @override
  MusicTrackingLifecycle copyWithProgress(TrackingProgressSnapshot progress) {
    return copyWith(
  ...
  @override
  MusicTrackingLifecycle copyWith({
    String? id,
