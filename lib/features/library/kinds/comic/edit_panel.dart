...
part 'edit_tabs/comic_primary_tabs.dart';
...
class ComicEditPanelState extends ConsumerState<ComicEditPanel>
  ...
  Widget _buildMainTab(BuildContext context) {
    return _buildMainTabBody(context);
  }

  Widget _buildDetailsTab() {
    return _buildDetailsTabBody();
  }

  Widget _buildValueTab() {
    return _buildValueTabBody();
  }

  Widget _buildPersonalTab() {
    return _buildPersonalTabBody();
  }
