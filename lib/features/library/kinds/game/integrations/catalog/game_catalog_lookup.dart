...
final class GameCatalogLookup implements CatalogKindLookup {
  ...
  CatalogSearchHit _hit(GameMedia media) {
  ...
  bool _matchesBarcode(GameMedia media, String normalized) {
  ...
  String? _itemNumber(GameMedia media) {
    final value =
        media.rawPayload['item_number'] ?? media.rawPayload['edition'];
