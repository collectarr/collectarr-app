...
Widget plannedMediaTableCell(
  ...
  return switch (column) {
    ...
    LibraryTableColumn.format => LibraryTableCellText(entry.referenceFormatLabel),
    ...
    LibraryTableColumn.price => Text(formatMoney(entry.pricePaidCents, entry.currency)),
