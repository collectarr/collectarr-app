// Test and composition-root barrel for concrete owned-detail types.
//
// The structural base remains in core. Concrete details are deliberately
// exported from the kind registry instead of being re-exported by a core
// model, so core cannot accidentally become a kind dispatch boundary.
...
export 'package:collectarr_app/features/library/kinds/book/ownership/book_owned_details_draft.dart';
...
export 'package:collectarr_app/features/library/kinds/tv/ownership/tv_owned_details_draft.dart';
