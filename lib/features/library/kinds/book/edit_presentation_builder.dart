  ...
  const BookLibraryEditPresentationBuilder()
      : super(
          ownedTabs: const [
            ...
            LibraryEditTabSpec(id: 'credits', icon: Icons.groups_2, label: 'Credits'),
            ...
            LibraryEditTabSpec(id: 'read_history', icon: Icons.auto_stories_outlined, label: 'Read History'),
            LibraryEditTabSpec(id: 'value', icon: Icons.attach_money, label: 'Value'),
            LibraryEditTabSpec(id: 'covers', icon: Icons.photo_camera_outlined, label: 'Covers'),
            LibraryEditTabSpec(id: 'photos', icon: Icons.image_outlined, label: 'My Images'),
            LibraryEditTabSpec(id: 'plot', icon: Icons.description_outlined, label: 'Plot'),
