...
final class BookTrackingState extends PersonalTrackingBase
  ...
  @override
  BookTrackingState copyWithProgress(TrackingProgressSnapshot progress) {
    return copyWith(
