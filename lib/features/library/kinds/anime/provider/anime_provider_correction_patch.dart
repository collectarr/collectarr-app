...
final class AnimeProviderCorrectionPatch implements ProviderCorrectionPatch {
  ...
  factory AnimeProviderCorrectionPatch.fromCandidates({
    required CatalogSearchCandidate preview,
    required CatalogSearchCandidate edited,
  }) {
    final before = requireProviderKindMetadata<AnimeMetadata>(preview);
    ...
    return AnimeProviderCorrectionPatch(
      ...
      editionTitle:
          providerStringPatch(before.editionTitle, after.editionTitle),
      ...
      releaseDate: providerDatePatch(before.startDate, after.startDate),
    );
  }
