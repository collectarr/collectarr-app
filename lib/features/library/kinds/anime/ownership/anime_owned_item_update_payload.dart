...
final class AnimeOwnedItemUpdatePayload
  ...
  factory AnimeOwnedItemUpdatePayload.partial({
    ...
    Patch<AnimeOwnedDetailsDraft> details = const Patch.unchanged(),
  }) =>
      AnimeOwnedItemUpdatePayload(
        targetRef: targetRef,
        quantity: quantity,
        condition: condition,
        grade: grade,
  ...
  @override
  bool canApplyTo(AnimeOwnedItem existing) => true;

  @override
  AnimeOwnedItem applyTo(
    AnimeOwnedItem existing, {
    required DateTime updatedAt,
    required String? fallbackOwnerUserId,
    required String? fallbackOwnerLabel,
  }) {
    final existingDetails = existing.details as AnimeOwnedDetails;
    final codec = const AnimeOwnedDetailsCodec();
