...
final animeLibraryGroupDefinitions = [
  ...
  LibraryGroupDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Title',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).title,
    sidebarTitle: 'Titles',
  ...
  LibraryGroupDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Release Date',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).releaseDate,
  ...
  LibraryGroupDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Release Year',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).releaseDate?.year,
  ...
  LibraryGroupDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).publisher,
    sidebarTitle: 'Studios / Networks',
  ...
  LibraryGroupDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Ownership',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).isOwned,
  ...
  LibraryGroupDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Added Date',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).addedAt,
  ...
  LibraryGroupDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).collectionStatus,
  ...
  LibraryGroupDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Condition',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).condition,
  ...
  LibraryGroupDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Location',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).locationPath,
  ...
  LibraryGroupDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Modified Date',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).updatedAt,
  ...
  LibraryGroupDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'My Rating',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).rating,
  ...
  LibraryGroupDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Tags',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).tags,
    sidebarTitle: 'Tags',
...
final animeLibrarySortDefinitions = [
  LibrarySortDefinition<LibraryWorkspaceEntry>(
    id: 'series',
    compare: (left, right) {
      final l = AnimeWorkspaceDto.fromEntry(left);
      final r = AnimeWorkspaceDto.fromEntry(right);
...
final animeLibraryColumnDefinitions = [
  LibraryColumnDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Status',
    getValue: (entry) {
      final dto = AnimeWorkspaceDto.fromEntry(entry);
  ...
  LibraryColumnDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Title',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).title,
    cellValue: (entry) => Text(AnimeWorkspaceDto.fromEntry(entry).title),
    defaultWidth: 260,
    maxWidth: 520,
  ),
  LibraryColumnDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Studio',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).publisher,
    cellValue: (entry) => Text(AnimeWorkspaceDto.fromEntry(entry).publisher ?? ''),
    defaultWidth: 140,
  ),
  LibraryColumnDefinition<LibraryWorkspaceEntry, Object?>(
    id: LibraryFieldId<Object?>('release_date'),
    label: 'Release Date',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).releaseDate,
    cellValue: (entry) => Text(_formatDate(AnimeWorkspaceDto.fromEntry(entry).releaseDate)),
    defaultWidth: 118,
  ),
  LibraryColumnDefinition<LibraryWorkspaceEntry, Object?>(
    id: LibraryFieldId<Object?>('wishlist'),
    label: 'Wishlist',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).isWishlisted,
    cellValue: (entry) => Text(AnimeWorkspaceDto.fromEntry(entry).isWishlisted ? 'Wishlist' : ''),
    group: 'Personal',
    defaultWidth: 82,
    minWidth: 70,
  ),
  LibraryColumnDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Updated',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).updatedAt,
    cellValue: (entry) => Text(_formatDate(AnimeWorkspaceDto.fromEntry(entry).updatedAt)),
    group: 'Personal',
    defaultWidth: 112,
  ),
  LibraryColumnDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Added',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).addedAt,
    cellValue: (entry) => Text(_formatDate(AnimeWorkspaceDto.fromEntry(entry).addedAt)),
    group: 'Personal',
    defaultWidth: 112,
  ),
  LibraryColumnDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Location',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).locationPath,
    cellValue: (entry) => Text(AnimeWorkspaceDto.fromEntry(entry).locationPath ?? ''),
    group: 'Personal',
    defaultWidth: 118,
  ),
  LibraryColumnDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Condition',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).condition,
    cellValue: (entry) => Text(AnimeWorkspaceDto.fromEntry(entry).condition ?? ''),
    group: 'Value',
    defaultWidth: 124,
  ),
  LibraryColumnDefinition<LibraryWorkspaceEntry, Object?>(
    ...
    label: 'Purchase Price',
    getValue: (entry) => AnimeWorkspaceDto.fromEntry(entry).pricePaidCents,
    cellValue: (entry) {
      final dto = AnimeWorkspaceDto.fromEntry(entry);
