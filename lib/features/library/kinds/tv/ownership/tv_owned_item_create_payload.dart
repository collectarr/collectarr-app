...
final class TvOwnedItemCreatePayload implements OwnedItemCreatePayload {
  const TvOwnedItemCreatePayload({
  ...
  factory TvOwnedItemCreatePayload.fromOwnedItem(
    CatalogItem item,
    OwnedItem ownedItem,
  ) {
    return TvOwnedItemCreatePayload(
      catalogRef: item.catalogRef,
      details: TvOwnedDetailsCodec().draftFromDetails(
        ownedItem.details as TvOwnedDetails,
      ),
  ...
  final TvOwnedDetailsDraft details;

  @override
  TvOwnedDetailsDraft get detailsDraft => details;
  final int quantity;
