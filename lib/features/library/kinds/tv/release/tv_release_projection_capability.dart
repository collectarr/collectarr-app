...
final class TvReleaseProjectionCapability<TDto extends LibraryWorkspaceDto>
    implements ReleaseProjectionCapability<TDto> {
  const TvReleaseProjectionCapability();
  ...
  List<LibraryProjectionItem<TDto>> projectReleases({
    ...
    const releaseSource = TvReleaseDetailSource();
