...
class TvAddPreviewSeasonsSection extends ConsumerWidget {
  const TvAddPreviewSeasonsSection({
    super.key,
    required this.kind,
        ...
        return Column(
          ...
          children: [
            ...
            for (final season in seasons)
              _TvAddPreviewSeasonNode(season: season, accent: accent),
          ],
        );
      },
    );
...
class _TvAddPreviewSeasonNode extends StatefulWidget {
  const _TvAddPreviewSeasonNode({
  ...
  @override
  State<_TvAddPreviewSeasonNode> createState() =>
      _TvAddPreviewSeasonNodeState();
}

class _TvAddPreviewSeasonNodeState extends State<_TvAddPreviewSeasonNode> {
