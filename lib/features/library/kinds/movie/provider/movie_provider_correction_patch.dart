...
final class MovieProviderCorrectionPatch implements ProviderCorrectionPatch {
...
Map<String, Object?> encodeMovieProviderCorrectionsForWire(
  ProviderCorrectionPatch patch,
) {
  if (patch is EmptyProviderCorrectionPatch) {
    return const <String, Object?>{};
  }
  if (patch is! MovieProviderCorrectionPatch) {
    throw StateError('Movie correction encoder received ${patch.runtimeType}.');
  }
