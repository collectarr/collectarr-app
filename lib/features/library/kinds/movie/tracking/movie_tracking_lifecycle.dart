...
final class MovieTrackingLifecycle extends PersonalTrackingBase
  ...
  @override
  MovieTrackingLifecycle copyWithProgress(TrackingProgressSnapshot progress) {
    return copyWith(
  ...
  @override
  MovieTrackingLifecycle copyWith({
    String? id,
