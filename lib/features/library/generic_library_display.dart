...
class GenericLibraryMetaChip extends StatelessWidget {
  const GenericLibraryMetaChip({
    super.key,
    required this.icon,
    required this.label,
...
class GenericLibraryItemPill extends StatelessWidget {
  const GenericLibraryItemPill({
    super.key,
    required this.label,
    required this.color,
  });
...
class GenericLibraryStatPill extends StatelessWidget {
  const GenericLibraryStatPill({
    super.key,
    required this.label,
    required this.value,
  });
