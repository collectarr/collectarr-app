...
/// Builds the [LibraryCardPresentation] for a video workspace item (movies, TV, anime).
LibraryCardPresentation buildVideoCardPresentation(
  LibraryProjectionRuntime item, {
  required bool musicVertical,
}) {
  return LibraryCardPresentation(
    compactBadges: _videoCompactBadges(item),
  );
}

List<LibraryCardBadge> _videoCompactBadges(LibraryProjectionRuntime item) {
  final dto = item.dto;
