...
const List<GeneratedMetadataField> kGeneratedMetadataFields = [
  ...
  (key: 'identifiers', label: 'Identifiers', section: 'relations', valueType: 'stringList', inputType: 'text', normalizedValueType: null),
  (key: 'company_roles', label: 'Company roles', section: 'relations', valueType: 'stringList', inputType: 'text', normalizedValueType: null),
  (key: 'contributors', label: 'Contributors', section: 'relations', valueType: 'stringList', inputType: 'text', normalizedValueType: null),
  (key: 'mechanics', label: 'Mechanics', section: 'relations', valueType: 'stringList', inputType: 'text', normalizedValueType: null),
  (key: 'categories', label: 'Categories', section: 'relations', valueType: 'stringList', inputType: 'text', normalizedValueType: null),
  (key: 'families', label: 'Families', section: 'relations', valueType: 'stringList', inputType: 'text', normalizedValueType: null),
  (key: 'expansions', label: 'Expansions', section: 'relations', valueType: 'stringList', inputType: 'text', normalizedValueType: null),
  (key: 'rankings', label: 'Rankings', section: 'relations', valueType: 'stringList', inputType: 'text', normalizedValueType: null),
  ...
  (key: 'release_date', label: 'Release date', section: 'item', valueType: 'partialDate', inputType: 'text', normalizedValueType: null),
  ...
  (key: 'nr_discs', label: 'Number of discs', section: 'technical', valueType: 'integer', inputType: 'number', normalizedValueType: null),
  (key: 'screen_ratio', label: 'Screen ratio', section: 'technical', valueType: 'text', inputType: 'text', normalizedValueType: null),
  (key: 'audio_tracks', label: 'Audio tracks', section: 'technical', valueType: 'text', inputType: 'text', normalizedValueType: null),
  (key: 'subtitles', label: 'Subtitles', section: 'technical', valueType: 'text', inputType: 'text', normalizedValueType: null),
  (key: 'layers', label: 'Layers', section: 'technical', valueType: 'text', inputType: 'text', normalizedValueType: null),
