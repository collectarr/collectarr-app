...
///
/// This compact item row is separate from [LibraryResultRow], which is the
/// typed data descriptor used by the shared result table.
class LibraryResultItemRow extends StatelessWidget {
  const LibraryResultItemRow({
    super.key,
    required this.title,
    this.subtitle,
    this.leading,
