...
class ProviderDescriptor {
  ...
  factory ProviderDescriptor.fromJson(Map<String, dynamic> json) {
    ...
    return ProviderDescriptor(
      ...
      supportsSearch: json['supportsSearch'] ?? json['supports_search'] ?? true,
      supportsIngest: json['supportsIngest'] ?? json['supports_ingest'] ?? true,
      requiresUserKey:
          json['requiresUserKey'] ?? json['requires_user_key'] ?? false,
      nonCommercialOnly:
          json['nonCommercialOnly'] ?? json['non_commercial_only'] ?? false,
      allowsRedistribution: json['allowsRedistribution'] ??
          json['allows_redistribution'] ??
          false,
      allowsImageMirroring: json['allowsImageMirroring'] ??
          json['allows_image_mirroring'] ??
          false,
      requiresAttribution:
          json['requiresAttribution'] ?? json['requires_attribution'] ?? false,
      licenseName:
