          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: TabBarView(
                  children: [
                    _ExportWizardPane(entries: widget.entries),
                    _ImportWizardPane(
...
class _ExportWizardPane extends StatelessWidget {
  const _ExportWizardPane({required this.entries});
  ...
  Widget build(BuildContext context) {
    ...
    final collectarr = csv.exportShelf(entries);
    final clz = csv.exportClzFriendlyShelf(entries);
