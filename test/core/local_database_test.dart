...
void main() {
  ...
  test('migrates a v7 cache to v24 without losing existing cache rows',
      () async {
  ...
  test('destructively rebuilds a higher-versioned cache to the v24 schema',
      () async {
    ...
    await old.customStatement('PRAGMA user_version = 25');
    await old.close();
