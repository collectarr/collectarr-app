...
void main() {
  ...
  test('migrates a v7 cache to v31 without losing existing cache rows',
      () async {
    ...
    expect(version.data.values.first, 31);
  });
  ...
  test('destructively rebuilds a higher-versioned cache to the v31 schema',
      () async {
