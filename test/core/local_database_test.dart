...
void main() {
  ...
  test('migrates a v7 cache to v19 without losing existing cache rows',
      () async {
    ...
    expect(version.data.values.first, 19);
  });
  ...
  test('destructively rebuilds a higher-versioned cache to the v19 schema',
      () async {
