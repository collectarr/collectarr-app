...
void main() {
  group('MovieReleaseProjectionCapability', () {
    const capability = MovieReleaseProjectionCapability<LibraryWorkspaceDto>();
    final typeConfig = libraryKindRegistrationForKind(CatalogMediaKind.movie);
