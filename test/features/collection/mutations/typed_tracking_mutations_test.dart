...
void main() {
  ...
  late TrackingStorageRepository trackingLifecycles;
  ...
  group('Typed Tracking Mutations Contract Tests', () {
    test('supports CatalogTrackingTarget with valid CatalogEntityRef',
      ...
      final entry =
          (await trackingLifecycles.findActiveStorageRecordsByCatalogRoots([
    ...
    test('replaces an existing catalog target when explicitly cleared',
      ...
      final entry = (await trackingLifecycles
              .findActiveStorageRecordsByCatalogRoots([ref]))
          .single;
    ...
    test('keeps TV season coordinates in the TV import contribution', () async {
      ...
      final entry =
          (await trackingLifecycles.listActiveStorageRecords()).single;
    ...
    test('owned sync preserves kind-owned tracking state on existing entries',
      ...
      await trackingLifecycles.upsertStorageRecord(
        TvTrackingLifecycle(
          id: 'tracking-tv-1',
          catalogRef: ref,
    ...
    test('typed tracking repository applies explicit clears', () async {
      ...
      await trackingLifecycles.upsertStorageRecord(existing);
      ...
      final updated = await trackingLifecycles.findStorageRecordByRef(
